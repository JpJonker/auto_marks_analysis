...
const PrivacyPolicy = () => {
  return (
    <div style={{ marginTop: "1rem", marginBottom: "1rem" }}>
      ...
      <p>
        {" "}
        Auto Excel Tool (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy
        Policy explains how your personal information is collected, used, and disclosed by Auto
        Excel Tool.
      </p>
      <p>
        This Privacy Policy applies to our website, and its associated subdomains (collectively, our
        “Service”) alongside our application, Auto Excel Tool. By accessing or using our Service,
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            Excel Tool, that is responsible for your information under this Privacy Policy.
          </li>
          <li>
          ...
          <li>
            Customer: refers to the company, organization or person that signs up to use the Auto
            Excel Tool Service to manage the relationships with your consumers or service users.
          </li>
          <li>
          ...
          <li>
            Personnel: refers to those individuals who are employed by Auto Excel Tool or are under
      ...
      <p>
        ...
        may be used to connect your computer to the Internet. Other information collected
        automatically could be a login, e-mail address, password, computer and connection
        information such as browser plug-in types and versions and time zone setting, operating
        systems and platforms, purchase history, (we sometimes aggregate with similar information
        from other Users), the full Uniform Resource Locator (URL) clickstream to, through and from
        our Website that may include date and time; cookie number; parts of the site you viewed or
        searched for; and the phone number you used to call our Customer Services. We may also use
        browser data such as cookies, Flash cookies (also known as Flash Local Shared Objects) or
        similar data on certain parts of our Website for fraud prevention and other purposes. During
        your visits, we may use software tools such as JavaScript to measure and collect session
        information including page response times, download errors, length of visits to certain
        pages, page interaction information (such as scrolling, clicks, and mouse-overs), and
        methods used to browse away from the page. We may also collect technical information to help
        us identify your device for fraud prevention and diagnostic purposes.
      </p>
      <p>
        ...
        name, country, location, information about who and when you use our and other technical
      ...
      <p>
        ...
        or other transfer of all or substantially all of the assets of Auto Excel Tool or any of its
        Corporate Affiliates (as defined herein), or that portion of Auto Excel Tool or any of its
        Corporate Affiliates to which the Service relates, or in the event that we discontinue our
        business or file a petition or have filed against us a petition in bankruptcy,
      ...
      <p>
        ...
        with Auto Excel Tool, whether by ownership or otherwise. Any information relating to you
        that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in
        accordance with the terms of this Privacy Policy.
      </p>

      <h1>Governing Law</h1>
      <p>
        This Privacy Policy is governed by the laws of South Africa without regard to its conflict
        of laws provision. You consent to the exclusive jurisdiction of the courts in connection
      ...
      <p>
        The laws of South Africa, excluding its conflicts of law rules, shall govern this Agreement
        and your use of the app. Your use of the app may also be subject to other local, state,
        national, or international laws.
      </p>
      <p>
        By using Auto Excel Tool or contacting us directly, you signify your acceptance of this
      ...
      <p>
        ...
        websites not operated or controlled by Auto Excel Tool. We are not responsible for the
      ...
      <h1>Advertising</h1>
      <p>
        This app may contain third party advertisements and links to third party sites. Auto Excel
        Tool does not make any representation as to the accuracy or suitability of any of the
      ...
      <p>
        Advertising keeps Auto Excel Tool and many of the websites and services you use free of
      ...
      <p>
        ...
        are not endorsements or recommendations by Auto Excel Tool of the third party sites, goods
        or services. Auto Excel Tool takes no responsibility for the content of any of the ads,
      ...
      <p>
        These cookies collect information over time about your online activity on the app and other
        online services to make online advertisements more relevant and effective to you. This is
        ...
        Without cookies, it’s really hard for an advertiser to reach its audience, or to know how
      ...
      <p>
        ...
        which is why we have implemented GDPR controls as our baseline standard for all our
      ...
      <p>
        ...
        thing to do. At Auto Excel Tool we strongly believe that your data privacy is very important
        and we already have solid security and privacy practices in place that go beyond the
      ...
      <p>
        ...
        Auto Excel Tool processes or stores all personal data in fully vetted, DPA compliant
      ...
      <p>
        ...
        with the ability to access, update, retrieve and remove personal data. We got you! We've
        been set up as self service from the start and have always given you access to your data and
        your customers data. Our customer support team is here for you to answer any questions you
      ...
      <ul>
        <li>
          ...
          the: (1) categories of Personal Information we collect, use, or share; (2) purposes for
          which categories of Personal Information are collected or used by us; (3) categories of
          sources from which we collect Personal Information; and (4) specific pieces of Personal
      ...
      <p>
        ...
        it, the categories of sources from whom we collect Personal Information, and the third
